...
#
# Unit test for Lastfm scavenger.
...
from scavengers.lastfm_scavenger import LastfmScavenger
...
class LastfmTest(unittest.TestCase):
  def setUp(self):
    self.scavenger = LastfmScavenger(NAME, IN, OUT)
  ...
  def test_valid(self):
    ...
    self.assertEqual(str(response['gender']), GENDER)
