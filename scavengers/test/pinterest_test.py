...
#
# Unit test for Pinterest scavenger.
...
from scavengers.pinterest_scavenger import PinterestScavenger
...
PROFILE = "pinterest.com/andreisoare/"

class PinterestTest(unittest.TestCase):
  def setUp(self):
    self.scavenger = PinterestScavenger(NAME, IN, OUT)
  ...
  def test_valid(self):
    ...
    self.assertEqual(str(response['location']), LOCATION)
